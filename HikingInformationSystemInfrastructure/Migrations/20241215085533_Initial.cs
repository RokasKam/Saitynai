        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalDurationInMinutes = table.Column<double>(type: "double", nullable: false),
                    TotalElevationGain = table.Column<double>(type: "double", nullable: false),
                    Seasonality = table.Column<int>(type: "int", nullable: false),
                    TerrainType = table.Column<int>(type: "int", nullable: false),
                    SuitableForBeginners = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ElevationChange = table.Column<double>(type: "double", nullable: false),
                    NavigationNotes = table.Column<string>(type: "longtext", nullable: false),
                    TerrainType = table.Column<int>(type: "int", nullable: false),
                    SurfaceType = table.Column<int>(type: "int", nullable: false),
                    HikeId = table.Column<Guid>(type: "char(36)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RouteId = table.Column<Guid>(type: "char(36)", nullable: false)
                },
                constraints: table =>
                {
